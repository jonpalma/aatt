        ...
        <div class="page-content" >
            <div class="container" >
                <div class="sixteen columns" style="text-align:;">
                    <h2 class="purple-titulo">10 años recibiendo grupos de estudiantes, autoridades locales y viajeros en Europa.</h2>
                    <br>
                    <h3>
                        Galería de Fotos en París, Poitiers, Berlín, Ámsterdam, Zurich, Rotterdam y Copenhague.
                    </h3>
